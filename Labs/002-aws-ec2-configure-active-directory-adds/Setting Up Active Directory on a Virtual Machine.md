...
- Continue clicking 'Next' until you reach the installation options.
...
- Set a strong password for the domain administrator.
...
- Select 'New' &gt; 'User'.
- Enter the user's name (e.g., 'John Doe') and login name (e.g., 'JohnDoe256').
- Set a password and configure any additional settings.
